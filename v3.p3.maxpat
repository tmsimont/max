...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 342.0, 371.0, 232.0, 85.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 581.5, 219.0, 45.0, 45.0 ],
					"varname" : "ezd"
				}
...
,
					"patching_rect" : [ 0.0, 0.0, 350.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 360.0, 0.0, 120.0, 20.0 ],
					"text" : "receive~ signal-seq0"
				}
...
, 							{
								"box" : 								{
									"embedstate" : [ [ "set", "lofi.hats.hat5.wav" ], [ "bang" ] ],
									"fontname" : "Arial",
									"fontsize" : 12.0,
									"id" : "obj-7",
									"maxclass" : "newobj",
...
, 											{
												"box" : 												{
													"embedstate" : [ [ "reload", "lofi.hats.hat5.wav" ] ],
													"fontname" : "Arial",
													"fontsize" : 12.0,
													"id" : "obj-3",
													"maxclass" : "newobj",
...
,
					"patching_rect" : [ 0.0, 70.0, 350.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 360.0, 70.0, 120.0, 20.0 ],
					"text" : "receive~ signal-seq1"
				}
...
,
					"patching_rect" : [ 0.0, 140.0, 350.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 360.0, 140.0, 120.0, 20.0 ],
					"text" : "receive~ signal-seq2"
				}
...
,
					"patching_rect" : [ 0.0, 210.0, 350.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 360.0, 210.0, 120.0, 20.0 ],
					"text" : "receive~ signal-seq3"
				}
